...
#ifndef FUNCTIONBLOCKS_THERMOCLIENTIF_H_
#define FUNCTIONBLOCKS_THERMOCLIENTIF_H_
#include <string>
#include <set>
...
const std::string PROP_THERMO_CURRREGIME = "currRegime";
const std::string PROP_THERMO_CURRTEMP = "currTemp";
const std::string PROP_THERMO_SETTEMP = "setTemp";
...
public:
	/**
	 * @brief Destroy the ThermoClientIf object
	 *
	 */
	virtual ~ThermoClientIf() {};
	 ...
	 * @param cloudValue: The value received from the cloud 
	 */
	virtual void currTemp(double cloudValue) = 0;
...
#endif /* FUNCTIONBLOCKS_THERMOCLIENTIF_H_ */
