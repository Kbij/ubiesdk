...
#ifndef MOCK_SPEAKERIF_H_
#define MOCK_SPEAKERIF_H_

#include "Sdk/Fb/SpeakerIf.h"
...
namespace SdkNs
{
class SpeakerMock: public SdkNs::SpeakerIf
{
public:
	...
	MOCK_METHOD1(registerClient, void(SdkNs::SpeakerClientIf*));
	MOCK_METHOD0(unRegisterClient, void());

	MOCK_METHOD1(volume, void(int ubieValue));

	MOCK_METHOD1(volumeConfig, void(const SdkNs::SpeakerDef::volumeConf& conf));

	MOCK_METHOD1(commitHistory, void(const std::vector<SdkNs::SpeakerDef::HistoryState>&));
};
}
#endif /* MOCK_SPEAKERIF_H_ */
