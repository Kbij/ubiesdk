...
#ifndef MOCK_ANALOGIF_H_
#define MOCK_ANALOGIF_H_

#include "Sdk/Fb/AnalogIf.h"
...
namespace SdkNs
{
class AnalogMock: public SdkNs::AnalogIf
{
public:
	...
	MOCK_METHOD1(registerClient, void(SdkNs::AnalogClientIf*));
	MOCK_METHOD0(unRegisterClient, void());

	MOCK_METHOD1(value, void(double ubieValue));

	MOCK_METHOD1(valueConfig, void(const SdkNs::AnalogDef::valueConf& conf));

	MOCK_METHOD1(offCompleted, void(bool success));

	MOCK_METHOD1(onCompleted, void(bool success));

	MOCK_METHOD1(commitHistory, void(const std::vector<SdkNs::AnalogDef::HistoryState>&));
};
}
#endif /* MOCK_ANALOGIF_H_ */
